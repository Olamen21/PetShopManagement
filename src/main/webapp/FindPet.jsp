                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        <div class="header-wrap">
                            <form class="form-header" action="FindPet" method="POST">
                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        <div style="background-color: pink; height: 40px;">
                            <label class="text-dark" style="margin:7px 0 0 7px;">DANH SÁCH </label>
                        </div><br>
                        </form>
                            <br>
						...
						<c:forEach items="${list}" var="o" >
	                       			<tr>
	                       				...
	                       				<td><p>${o.PCat}</p></td>
	                       				<td><p>${o.pprice }</p></td>
	                       				<td><a href="updatePet?id=${o.PId}">Update</a></td>
                            ...
                            <a class="btn btn-outline-dark" href="AddPet.jsp" >Thêm mới</a>
...
<script>
	function showMess(id){
		...
		if(option === true){
			window.location.href = 'DeletePet?id='+id;
		}
	}
</script>
